...
class UserManagementTest extends TestCase
{
    ...
    public function test_new_user_is_seeded_with_default_exercises()
    {
        ...
        $this->assertCount(21, $newUser->exercises);
        ...
        // Verify some of the new exercises for workout programs
        $this->assertDatabaseHas('exercises', ['user_id' => $newUser->id, 'title' => 'Zombie Squats']);
        $this->assertDatabaseHas('exercises', ['user_id' => $newUser->id, 'title' => 'Overhead Press']);
        $this->assertDatabaseHas('exercises', ['user_id' => $newUser->id, 'title' => 'Romanian Deadlifts']);
        $this->assertDatabaseHas('exercises', ['user_id' => $newUser->id, 'title' => 'Conventional Deadlift']);
    }
}

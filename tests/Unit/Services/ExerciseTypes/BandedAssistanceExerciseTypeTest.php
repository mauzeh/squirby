...
class BandedAssistanceExerciseTypeTest extends TestCase
{
    ...
    /** @test */
    public function it_formats_suggestion_text_for_banded_assistance_exercise()
    {
        $suggestion = (object)[
            'band_color' => 'green',
            'reps' => 8,
        ...
        $this->assertEquals('Suggested: Green band × 8 reps × 3 sets', $formatted);
    }
    ...
    public function it_formats_suggestion_text_with_default_sets()
    {
        ...
        $this->assertEquals('Suggested: Yellow band × 10 reps × 3 sets', $formatted);
    }
    
    /** @test */
    public function it_returns_null_when_banded_assistance_suggestion_missing_band_color()
    {
        $suggestion = (object)[
            'reps' => 10
        ];
    ...
    /** @test */
    public function it_returns_null_when_banded_assistance_suggestion_missing_reps()
    {
        $suggestion = (object)[
            'band_color' => 'green'
        ];

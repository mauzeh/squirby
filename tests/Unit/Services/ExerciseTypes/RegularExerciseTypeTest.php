...
class RegularExerciseTypeTest extends TestCase
{
    ...
    /** @test */
    public function it_formats_suggestion_text_for_weighted_exercise()
    {
        $suggestion = (object)[
            'suggestedWeight' => 185,
            'reps' => 8,
        ...
        $this->assertEquals('Suggested: 185 lbs × 8 reps × 4 sets', $result);
    }

    /** @test */
    public function it_returns_null_when_suggestion_missing_reps()
    {
        $suggestion = (object)[
            'suggestedWeight' => 185,
            'sets' => 4
    ...
    /** @test */
    public function it_returns_null_when_suggestion_missing_weight()
    {
        $suggestion = (object)[
            'reps' => 8,
            'sets' => 4
    ...
    /** @test */
    public function it_uses_default_sets_when_not_provided()
    {
        $suggestion = (object)[
            'suggestedWeight' => 185,
            'reps' => 8
        ...
        $this->assertEquals('Suggested: 185 lbs × 8 reps × 3 sets', $result);
    }
}
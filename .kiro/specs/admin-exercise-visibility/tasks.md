...
- [ ] 1. Enhance Exercise model availableToUser scope for admin visibility
...
- [ ] 2. Create comprehensive test coverage for enhanced model scope
...
- [ ] 3. Verify system-wide functionality and security

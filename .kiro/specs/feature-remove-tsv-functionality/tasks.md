...
- [x] 1. Remove TSV import routes and middleware
...
- [x] 2. Remove TSV import controller methods
  - [x] 2.1 Remove `FoodLogController::importTsv` method
    - Remove method and related validation rules
    - Clean up TSV service constructor injection
    - _Requirements: 1.1, 3.1, 4.3_

  - [x] 2.2 Remove `IngredientController::importTsv` method
    - Remove method and related validation rules
    - Clean up TSV service constructor injection
    - _Requirements: 1.1, 3.1, 4.3_

  - [x] 2.3 Remove `BodyLogController::importTsv` method
    - Remove method and related validation rules
    - Clean up TSV service constructor injection
    - _Requirements: 1.1, 3.1, 4.3_

  - [x] 2.4 Remove `ExerciseController::importTsv` method
    - Remove method and related validation rules
    - Clean up TSV service constructor injection
    - _Requirements: 1.1, 3.1, 4.3_

  - [x] 2.5 Remove `LiftLogController::importTsv` method
    - Remove method and related validation rules
    - Clean up TSV service constructor injection
    - _Requirements: 1.1, 3.1, 4.3_

  - [x] 2.6 Remove `ProgramController::import` method
    - Remove method and related validation rules
    - Clean up TSV service constructor injection
    - _Requirements: 1.1, 3.1, 4.3_

- [x] 3. Remove TSV import forms from views
  - [x] 3.1 Remove TSV forms from `resources/views/food_logs/index.blade.php`
    - Remove TSV import form and environment conditionals
    - _Requirements: 1.2, 3.3, 4.2_

  - [x] 3.2 Remove TSV forms from `resources/views/ingredients/index.blade.php`
    - Remove TSV import form and environment conditionals
    - _Requirements: 1.2, 3.3, 4.2_

  - [x] 3.3 Remove TSV forms from `resources/views/body-logs/index.blade.php`
    - Remove TSV import form and environment conditionals
    - _Requirements: 1.2, 3.3, 4.2_

  - [x] 3.4 Remove TSV forms from `resources/views/exercises/index.blade.php`
    - Remove TSV import form and environment conditionals
    - _Requirements: 1.2, 3.3, 4.2_

  - [x] 3.5 Remove TSV forms from `resources/views/lift-logs/index.blade.php`
    - Remove TSV import form and environment conditionals
    - _Requirements: 1.2, 3.3, 4.2_

  - [x] 3.6 Remove TSV forms from `resources/views/programs/index.blade.php`
    - Remove TSV import form and environment conditionals
    - _Requirements: 1.2, 3.3, 4.2_

- [x] 4. Remove TSV service classes
  - [x] 4.1 Remove `TsvImporterService` class
    - Delete `app/Services/TsvImporterService.php`
    - _Requirements: 1.4, 3.4_

  - [x] 4.2 Remove `IngredientTsvProcessorService` class
    - Delete `app/Services/IngredientTsvProcessorService.php`
    - _Requirements: 1.5, 3.4_

  - [x] 4.3 Remove `ProgramTsvImporterService` class
    - Delete `app/Services/ProgramTsvImporterService.php`
    - _Requirements: 1.4, 3.4_

- [x] 5. Create hardcoded ingredient seeder
  - [x] 5.1 Design minimal ingredient dataset
  ...
  - [x] 5.2 Implement new `IngredientSeeder` class
...
- [x] 6. Create hardcoded exercise seeder
  - [x] 6.1 Design minimal exercise dataset
    - Create array of 20-25 common exercises covering major muscle groups
    - Include both bodyweight and weighted exercises
    - Cover upper body, lower body and core
    - _Requirements: 2.2, 2.4, 5.2, 5.3_

  - [x] 6.2 Implement new `GlobalExercisesSeeder` class
...
- [x] 7. Remove CSV data files and TSV tests
  - [x] 7.1 Remove CSV files from seeders
  ...
  - [x] 7.2 Remove TSV-related test files
...
- [x] 9. Verify removal completeness
  ...
  - [x] 9.3 Verify application functionality

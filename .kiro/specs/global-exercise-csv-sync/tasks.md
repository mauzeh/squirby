...
- [ ] 1. Update CSV file structure to support band_type column
...
- [ ] 2. Enhance console command data collection methods
  - [ ] 2.1 Update global exercises query to include band_type field
  ...
  - [ ] 2.2 Implement CSV parsing with band_type support
...
- [ ] 3. Implement exercise comparison and matching logic
  - [ ] 3.1 Create exercise comparison method
  ...
  - [ ] 3.2 Implement change identification system
...
- [ ] 4. Add user feedback and confirmation system
  - [ ] 4.1 Implement change reporting
...
- [ ] 5. Implement CSV synchronization
  - [ ] 5.1 Implement complete CSV rewrite
...
- [ ] 6. Rename and update command
  - [ ] 6.1 Rename command class and update signature
    - Rename class from PersistMissingGlobalExercises to SyncGlobalExercisesToCsv
  ...
  - [ ] 6.2 Enhance environment and file validation

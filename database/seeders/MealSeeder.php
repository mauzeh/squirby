...
class MealSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $meal1 = Meal::create(['name' => 'Breakfast Bowl', 'user_id' => $adminUser->id]);
        ...
        $meal2 = Meal::create(['name' => 'Evening Yogurt', 'user_id' => $adminUser->id]);
        ...
        // Meal 3: Nasi Goreng
        $meal3 = Meal::create(['name' => 'Nasi Goreng (Vegetarian Fried Rice)', 'user_id' => $adminUser->id]);
        ...
        $meal3 = Meal::create(['name' => 'Carb Loading Shake', 'user_id' => $adminUser->id]);
        ...
        $meal3 = Meal::create(['name' => 'Roasted Chicken from the Oven (1 serving of 140g chicken)', 'user_id' => $adminUser->id]);
        ...
        $meal3 = Meal::create(['name' => 'Japanese Sweet Potato (250g) from the Oven', 'user_id' => $adminUser->id]);
        ...
        $meal3 = Meal::create(['name' => 'Roasted Chicken from the Oven (5 servings @ 140g chicken/serving)', 'user_id' => $adminUser->id]);
        $meal3->ingredients()->attach($ingredients['Broccoli (dry)']->id, ['quantity' => 100]);
        ...
        $meal4 = Meal::create(['name' => 'Fusili with Veggies & Red Sauce (1 serving)', 'user_id' => $adminUser->id]);
        ...
        $meal5 = Meal::create(['name' => 'Hans made Rice Bowl with Chicken and Veggies', 'user_id' => $adminUser->id]);
        ...
        $meal6 = Meal::create(['name' => 'Direct Entry Template (1000 cal, 35g fat, 1500mg sodium)', 'user_id' => $adminUser->id]);
        ...
        $meal7 = Meal::create(['name' => 'Apple & Cashews', 'user_id' => $adminUser->id]);
